...
export const tools = [
  ...
  {
    name: 'get_settings',
    description: 'Get shared reading-room settings. context_chars is how many characters of surrounding text to include on each side of a selection when discussing it.',
    inputSchema: { type: 'object', properties: {}, required: [] },
  },
  {
